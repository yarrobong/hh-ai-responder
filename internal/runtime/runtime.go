...
type Config struct {
	...
	CareerAgentDailySchedulerEnabled bool
	CareerAgentDailyInterval         time.Duration
}
...
func legacyConfigFromPackage(value appconfig.Config) Config {
	return Config{
		...
		CareerAgentDailySchedulerEnabled: value.CareerAgentDailySchedulerEnabled,
		CareerAgentDailyInterval:         value.CareerAgentDailyInterval,
	}
}
