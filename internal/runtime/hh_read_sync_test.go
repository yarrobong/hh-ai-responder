...
func TestHHReadSyncImportsAndUpdatesVacancyAndAnalyzes(t *testing.T) {
	...
	service := NewHHReadSyncServiceWithOptions(fake, HHReadSyncServiceOptions{Vacancies: vacancies, Applications: applications, Conversations: conversations, Analyzer: spy, StatePath: statePath})
...
func TestHHReadSyncRefreshesOneConversation(t *testing.T) {
	...
	service := NewHHReadSyncServiceWithOptions(fake, HHReadSyncServiceOptions{Applications: applications, Conversations: conversations, StatePath: statePath})
...
func TestHHReadSyncImportsApplicationAndUnknownStatusSafely(t *testing.T) {
	...
	service := NewHHReadSyncServiceWithOptions(fake, HHReadSyncServiceOptions{Vacancies: vacancies, Applications: applications, Conversations: conversations, StatePath: statePath})
...
func TestHHReadSyncContextAndInboxAreReadOnly(t *testing.T) {
	...
	service := NewHHReadSyncServiceWithOptions(fake, HHReadSyncServiceOptions{Conversations: conversations, StatePath: statePath})
	...
	inbox, err := NewHHReadSyncServiceWithOptions(nil, HHReadSyncServiceOptions{Conversations: conversations}).GetCandidateInbox()
...
func TestHHReadSyncErrorsDoNotOverwriteStore(t *testing.T) {
	...
	service := NewHHReadSyncServiceWithOptions(&syncFakeReadClient{vacancyErr: errors.New("401 Unauthorized")}, HHReadSyncServiceOptions{Vacancies: vacancies, Applications: applications, Conversations: conversations, StatePath: statePath})
